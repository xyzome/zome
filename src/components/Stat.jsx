      ...
      <div className="max-w-screen-xl px-4 py-8 mx-auto text-center lg:py-16 lg:px-6">
        <dl className="grid max-w-screen-md gap-8 mx-auto text-gray-900 sm:grid-cols-3 dark:text-white">
          <div
            ...
            data-aos-delay="100"
          >
            <dt className="mb-2 text-3xl md:text-4xl font-extrabold"><CountUp start={0} end={50} duration={15} />+</dt>
          ...
          <div
            ...
            data-aos-delay="200"
          >
            <dt className="mb-2 text-3xl md:text-4xl font-extrabold"><CountUp start={0} end={30} duration={15}/>+</dt>
          ...
          <div
            ...
            data-aos-delay="300"
          >
            <dt className="mb-2 text-3xl md:text-4xl font-extrabold"><CountUp start={0} end={10} duration={10} />+</dt>
